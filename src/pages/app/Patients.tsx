...
const Patients = () => {
  ...
  const C = {
    ...
    purpleSoft: "hsl(var(--primary) / 0.12)",
    purpleInk: "hsl(var(--primary-dark))",
    gold: "hsl(var(--primary))",
    goldSoft: "hsl(var(--primary) / 0.12)",
    goldBorder: "hsl(var(--primary) / 0.3)",
    green: "hsl(var(--moss))",
    greenSoft: "hsl(var(--moss) / 0.15)",
    greenBorder: "hsl(var(--moss) / 0.45)",
    red: "hsl(var(--destructive))",
    redSoft: "hsl(var(--destructive) / 0.14)",
    neutralBg: "hsl(var(--muted))",
    avatarA: "hsl(var(--primary) / 0.14)",
    avatarB: "hsl(var(--primary) / 0.20)",
    avatarC: "hsl(var(--primary) / 0.26)",
  };
